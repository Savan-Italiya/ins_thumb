...
const config = {
  ...
  bashSMS: {
    baseUrl: process.env.WA_BASH_SMS_URL,
    password: process.env.WA_BASH_SMS_PASSWORD,
    userName: process.env.WA_BASH_SMS_USER_NAME,
    senderId: process.env.WA_BASH_SMS_SENDER_ID,
    template: process.env.WA_BASH_SMS_TEMPLATE_NAME
  } ,
